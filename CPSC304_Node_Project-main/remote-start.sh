...
#     export LD_LIBRARY_PATH=$ORACLE_HOME/lib
# elif [ -d /home/o/oracle ]; then     # <-- ADD THIS
...
if [ -d /opt/oracle/instantclient_23_7 ]; then
    echo "Found at /opt/oracle/instantclient_23_7"
    export ORACLE_HOME=/opt/oracle/instantclient_23_7
    export LD_LIBRARY_PATH=$ORACLE_HOME
elif [ -d /usr/lib/oracle/19.6/client64/lib ]; then
    echo "Found at /usr/lib/oracle/19.6/client64/lib"
    export ORACLE_HOME=/usr/lib/oracle/19.6/client64
elif [ -d /usr/lib/oracle/12.2/client64/lib ]; then
    echo "Found at /usr/lib/oracle/12.2/client64/lib"
    export ORACLE_HOME=/usr/lib/oracle/12.2/client64
    export LD_LIBRARY_PATH=$ORACLE_HOME/lib
elif [ -d /home/o/oracle ]; then
    echo "Found at /home/o/oracle"
    export ORACLE_HOME=/home/o/oracle
    export LD_LIBRARY_PATH=$ORACLE_HOME/lib
else
    echo "Oracle not found... exiting."
    exit 1
fi
