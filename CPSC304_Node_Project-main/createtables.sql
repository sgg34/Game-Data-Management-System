...
DROP TABLE Player_Has_R1 CASCADE CONSTRAINTS;
DROP TABLE Player_Has_Avatar CASCADE CONSTRAINTS;
...
DROP TABLE Skill_R1 CASCADE CONSTRAINTS;
DROP TABLE Turn_Has_R1 CASCADE CONSTRAINTS;
DROP TABLE Turn_Has_R2 CASCADE CONSTRAINTS;
DROP TABLE Skill_R2 CASCADE CONSTRAINTS;
DROP TABLE Attack CASCADE CONSTRAINTS;
DROP TABLE Defence CASCADE CONSTRAINTS;
DROP TABLE Agility CASCADE CONSTRAINTS;
DROP TABLE Round_Provides CASCADE CONSTRAINTS;
DROP TABLE Player_Has_R2 CASCADE CONSTRAINTS;
DROP TABLE Iron CASCADE CONSTRAINTS;
DROP TABLE Bronze CASCADE CONSTRAINTS;
DROP TABLE Silver CASCADE CONSTRAINTS;
DROP TABLE Gold CASCADE CONSTRAINTS;
DROP VIEW AvgPointsByRanking;
...
INSERT INTO Player_Has_Avatar VALUES ('Damien', 'A000000001'); 
INSERT INTO Player_Has_Avatar VALUES ('Jerry', 'A000000001'); 
INSERT INTO Player_Has_Avatar VALUES ('Felix', 'A000000001'); 
INSERT INTO Player_Has_Avatar VALUES ('Aeris', 'A000000001'); 

INSERT INTO Player_Has_Avatar VALUES ('Sammie', 'A000000004'); 
INSERT INTO Player_Has_Avatar VALUES ('Damien', 'A000000004'); 
INSERT INTO Player_Has_Avatar VALUES ('Jerry', 'A000000004'); 
INSERT INTO Player_Has_Avatar VALUES ('Aeris', 'A000000004'); 
...
CREATE VIEW AvgPointsByRanking(rankingID, avgpoints) as
    SELECT  P.RankingID, Avg(P.Points) AS avgpoints
    FROM Player_Has_R1 P
